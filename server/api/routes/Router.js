...
authapp.post(`/signup`, userController.signup)
       ...
       .get(`/session`,verfy_token, sessionController.view_all_sessions)
       .patch(`/sessions/:sessionId/accept`,verfy_admin_and_mentor, sessionController.accept_session)
       .patch(`/sessions/:sessionId/reject`, verfy_admin_and_mentor, sessionController.reject_session)
